              ...
              <ul className="glide__slides">
                <li className="glide__slide">
                  <img
                    alt="..."
                    height="500"
                    src={require("assets/img/theme/sofia-kuniakina.jpg").default}
                    width="450"
                  ></img>
                </li>
                <li className="glide__slide">
                  <img
                    alt="..."
                    height="500"
                    src={require("assets/img/theme/sacha-styles.jpg").default}
                    width="450"
                  ></img>
                </li>
                <li className="glide__slide">
                  <img
                    alt="..."
                    height="500"
                    src={require("assets/img/theme/victor-garcia.jpg").default}
                    width="450"
                  ></img>
                </li>
                <li className="glide__slide">
                  <img
                    alt="..."
                    height="500"
                    src={require("assets/img/theme/doyoun-seo.jpg").default}
                    width="450"
                  ></img>
                </li>
                <li className="glide__slide">
                  <img
                    alt="..."
                    height="500"
                    src={require("assets/img/theme/ayo-ogunseinde.jpg").default}
                    width="450"
                  ></img>
                </li>
              </ul>
