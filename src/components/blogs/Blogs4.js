            ...
            <Col lg="3">
              ...
              >
                <div
                  ...
                  style={{
                    backgroundImage:
                      "url(" + require("assets/img/sections/athena.jpg").default + ")",
                  }}
                ></div>
            ...
            <Col lg="3">
              ...
              >
                <div
                  ...
                  style={{
                    backgroundImage:
                      "url(" + require("assets/img/sections/thomas.jpg").default + ")",
                  }}
                ></div>
                <a href="#pablo" onClick={(e) => e.preventDefault()}>
                  <CardBody>
            ...
            <Col lg="3">
              ...
              >
                <div
                  ...
                  style={{
                    backgroundImage:
                      "url(" + require("assets/img/sections/odin.jpg").default + ")",
                  }}
                ></div>
                <a href="#pablo" onClick={(e) => e.preventDefault()}>
                  <CardBody>
            ...
            <Col lg="3">
              ...
              >
                <div
                  ...
                  style={{
                    backgroundImage:
                      "url(" + require("assets/img/sections/twk-tt.jpg").default + ")",
                  }}
                ></div>
                <a href="#pablo" onClick={(e) => e.preventDefault()}>
                  <CardBody>
            ...
            <Col lg="3">
              ...
              >
                <div
                  ...
                  style={{
                    backgroundImage:
                      "url(" + require("assets/img/theme/kit-suman.jpg").default + ")",
                  }}
                ></div>
                <a href="#pablo" onClick={(e) => e.preventDefault()}>
                  <CardBody>
            ...
            <Col lg="3">
              ...
              >
                <div
                  ...
                  style={{
                    backgroundImage:
                      "url(" + require("assets/img/sections/damian.jpg").default + ")",
                  }}
                ></div>
                <a href="#pablo" onClick={(e) => e.preventDefault()}>
                  <CardBody>
