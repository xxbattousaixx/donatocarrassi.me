                    ...
                    <div className="card-image shadow">
                      <a href="#pablo" onClick={(e) => e.preventDefault()}>
                        <img
                          ...
                          src={require("assets/img/faces/team-2.jpg").default}
                        ></img>
                      </a>
                    </div>
                  </Col>
                    ...
                    <CardBody>
                      ...
                      <div className="author">
                        <img
                          ...
                          src={require("assets/img/faces/team-1.jpg").default}
                        ></img>
                        <div className="text">
                    ...
                    <div className="card-image shadow">
                      <a href="#pablo" onClick={(e) => e.preventDefault()}>
                        <img
                          alt="..."
                          className="img rounded"
                          src={require("assets/img/faces/team-3.jpg").default}
                        ></img>
                      </a>
                    </div>
                  </Col>
                    ...
                    <CardBody>
                      ...
                      <div className="author">
                        <img
                          alt="..."
                          className="avatar img-raised"
                          src={require("assets/img/faces/team-5.jpg").default}
                        ></img>
                        <div className="text">
                    ...
                    <div className="card-image shadow">
                      <a href="#pablo" onClick={(e) => e.preventDefault()}>
                        <img
                          alt="..."
                          className="img rounded"
                          src={require("assets/img/faces/team-4.jpg").default}
                        ></img>
                      </a>
                    </div>
                  </Col>
